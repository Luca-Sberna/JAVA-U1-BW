...
public class MainInterattivo {
	...
	public static void main(String[] args) {
		...
		case 3:
			...
			System.out.println(
					"2. Visualizza la lista dei venditori e distributori");// teo
			...
			System.out
					.println("10. Crea e aggiungi un distributore automatico ");// teo
			...
			case 4:
				...
				if (modificaTratta.equalsIgnoreCase("Si")) {
					...
					md.findByIdAndUpdate(idMezzo, capienza, stato, tipoMezzoo,
							nuovaTratta);
				}
				break;
			...
			case 5:
				...
				System.out
						.println("Inserisci l'ID della tratta da modificare: ");
				...
				if (trattaDaModificare != null) {
					System.out
							.println("Inserisci la nuova città di partenza: ");
					...
					// SE L'UTENTE DIGITA "SI" VIENE MODIFICATA LA TRATTA E POI
			...
			case 6:
				...
				String venditoreIdString = scanner.next();// SALVA ID INSERITO
			...
			case 8:
				...
				System.out
						.println("Inserisci il numero di posti disponibili: ");
				...
				md.save(nuovoMezzo);
				System.out
						.println("Nuovo mezzo creato e aggiunto con successo!");
				break;
			...
			case 13:
				// CHIEDE IN INPUT ID TRATTA E ID MEZZO PER MOSTRARE LA TRATTA
			...
			case 15:
				// TROVA I BIGLIETTI VIDIMATI SU UN DETERMINATO MEZZO IN BASE A
				...
				log.info(
						"Il numero dei biglietti vidimati nel range che stavi cercando sono  "
								+ vbd.getBigliettiVidimatiPerMezzoInRange(
										idMezz, LocalDate.of(2025, 06, 26),
