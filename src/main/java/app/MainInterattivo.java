...
//		vad.save(venditore3);
		...
		case 3:
			...
			do {
				...
				System.out.println(" ");
				System.out
						.println("Sei nella sezione admin! Scegli cosa fare:");
				System.out.println(" ");
				System.out.println("1. Visualizza la lista dei mezzi");
				System.out.println(
						"2. Visualizza la lista dei venditori e distributori");
				...
				System.out.println(
						"8. Crea e aggiungi un mezzo con una tratta propria ");
				System.out.println(
						"9. Crea e aggiungi un venditore autorizzato ");
				System.out.println(
						"10. Crea e aggiungi un distributore automatico ");
				System.out.println(
						"11. Visualizza Abbonamenti attivi dal numero tessera");
				System.out.println(
						"12. Visualizza quante volte è stata percorsa una tratta");
				System.out.println(
						"13. Visualizza quante volte è stata percorsa una tratta da un singolo mezzo");
				System.out.println(
						"14. Visualizza le tessere scadute che devono essere rinnovate");
				System.out.println(
						"15. Visualizza numero biglietti vidimati in un periodo di tempo");
				...
				case 1:
					...
					System.out.println(
							"Ecco la lista dei mezzi e delle loro tratte");
					md.getAllMezzi().stream()
				...
				case 2:
					...
					System.out.println(
							"Ecco la lista dei venditori e distributori");
					pvd.getAllPuntiVendita().stream()
							.forEach(pv -> log.info(
									pv.getLuogo() + " " + pv.getNumeroVendite()
											+ " " + pv.getIdPuntoVendita()));
					// OPZIONE PER TORNARE INDIETRO
					System.out.println("0. Torna al menu admin");
				...
				case 4:
					...
					System.out.println(
							"Inserisci l'ID del mezzo che desideri modificare:");
					String id = scanner.next();
					UUID idMezzo = UUID.fromString(id);
					System.out
							.println("Inserisci la nuova capienza del mezzo:");
					long capienza = scanner.nextLong();
					scanner.nextLine();
					System.out.println(
							"Inserisci il nuovo stato del mezzo (OPZIONI_VALIDE):");
					String statoString = scanner.nextLine();
					statoMezzo stato = statoMezzo.valueOf(statoString);
					System.out.println(
							"Inserisci il nuovo tipo di mezzo (OPZIONI_VALIDE):");
					...
					// ⬇️⬇️⬇️
					System.out.println(
							"Desideri modificare la tratta associata? (Sì/No)");
					...
					if (modificaTratta.equalsIgnoreCase("Si")) {
						...
						System.out.println(
								"Inserisci la distanza tra la partenza e il capolinea: ");
						...
						// ⬇️⬇️⬇️
						Tratta nuovaTratta = new Tratta(partenza, destinazione,
								distanza, durata);
						td.save(nuovaTratta);
						...
						md.findByIdAndUpdate(idMezzo, capienza, stato,
								tipoMezzoo, nuovaTratta);
					}
				...
				case 5:
					...
					System.out.println(
							"Inserisci l'ID della tratta da modificare: ");
					...
					if (trattaDaModificare != null) {
						System.out.println(
								"Inserisci la nuova città di partenza: ");
						String nuovaPartenza = scanner.next();
						System.out.println(
								"Inserisci la nuova città di destinazione: ");
						String nuovaDestinazione = scanner.next();
						System.out.println(
								"Inserisci la nuova distanza tra la partenza e il capolinea: ");
						double nuovaDistanza = scanner.nextDouble();
						System.out.println(
								"Inserisci la nuova durata totale del viaggio: ");
						...
						System.out
								.println("Città di partenza: " + nuovaPartenza);
						System.out.println(
								"Città di destinazione: " + nuovaDestinazione);
				...
				case 6:
					...
					System.out.println(
							"Inserisci l'ID del venditore autorizzato da modificare: ");
					...
					VenditoriAutorizzati venditoreEsistente = vad
							.getById(venditoreId);

					// SE TROVA IL VENDITORE VA AVANTI CON LA MODIFICA
					if (venditoreEsistente != null) {
						System.out.println(
								"Inserisci il nuovo nome del negozio: ");
						...
						vad.modificaVenditoreAutorizzato(venditoreId,
								datiAggiornati);
						System.out.println(
								"Venditore autorizzato modificato con successo!");
					} else {
						System.out
								.println("Venditore autorizzato non trovato.");
					}
					// OPZIONE PER TORNARE INDIETRO
					System.out.println("0. Torna al menu admin");
				...
				case 7:
					...
					System.out.println(
							"Inserisci l'ID del distributore da modificare: ");
					String distributoreId = scanner.next();

					// TROVA IL DISTRIBUTORE TRAMITE L'ID
					DistributoriAutomatici distributoreDaModificare = dad
							.getById(distributoreId);
					...
					if (distributoreDaModificare != null) {
						...
						System.out.println(
								"Inserisci il luogo del distributore: ");
						String nuovoLuogo = scanner.nextLine();
						System.out.println(
								"Inserisci il nuovo stato del distributore (FUNZIONANTE/FUORI_SERVIZIO):");
						...
						if (confermaModifiche.equalsIgnoreCase("Si")) {
							...
							System.out.println(
									"Distributore automatico modificato con successo!");
						} else {
							System.out.println("Modifica annullata.");
						}
					} else {
				...
				case 8:
					...
					System.out.println(
							"Inserisci il numero di posti disponibili: ");
					int postiDisponibili = scanner.nextInt();
					System.out.println(
							"Inserisci lo stato del mezzo (inServizio o inManutenzione): ");
					String statoMezzo = scanner.next();
					System.out
							.println("Inserisci la velocità media del mezzo: ");
					...
					Tratta tratta = new Tratta(partenza, destinazione, distanza,
							durata);

					// VIENE CREATA NUOVA ISTANZA MEZZO CON I DATI FORNITI
					Mezzo nuovoMezzo = new Mezzo(postiDisponibili,
							Mezzo.statoMezzo.valueOf(statoMezzo),
							Mezzo.tipoMezzo.valueOf(tipoMezzo), tratta);
					nuovoMezzo.setVelocitàMedia(velocitàMedia);

					md.save(nuovoMezzo);
					System.out.println(
							"Nuovo mezzo creato e aggiunto con successo!");
				...
				case 11:
					...
					System.out.println(
							"Inserisci l'id tessera dell'abbonamento che vuoi verificare");
					...
					ead.findAbbonamentiAttiviByNumeroTessera(numTessera)
							.stream()
							.forEach(abbonamento -> log
									.info("L'abbonamento che cercavi è: "
											+ abbonamento.getIdEmissione()
											+ " Data d'emissione: "
											+ abbonamento.getDataEmissione()
											+ " ,Data scadenza: "
				...
				case 12:
					...
					System.out.println(
							"Inserisci l'id della tratta che vuoi controllare ");
					String idTratta = scanner.next();
					log.info("La tratta che cercavi è stata percorsa tot: "
							+ td.getTimesTrattaPercorsa(idTratta));
				...
				case 13:
					...
					log.info(
							"La tratta percorsa dal singolo mezzo che cercavi è stata percorsa tot:  "
									+ td.getTimesTrattaPercorsaBySingleMezzo(
											idTrattaa, idMezzoo));
				...
				case 14:
					...
					ted.trovaTessereScadutePerUtente(idUtentee).stream()
				...
				case 15:
					...
					log.info(
							"Il numero dei biglietti vidimati nel range che stavi cercando sono  "
									+ vbd.getBigliettiVidimatiPerMezzoInRange(
											idMezz, LocalDate.of(2022, 04, 24),
